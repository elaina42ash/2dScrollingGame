...
class DroppedKatanaTileMapSensorComponent : public TileMapSensorComponent
{
private:
	Inject<IDroppedObjectView> droppedObjectView_;

public:
	DroppedKatanaTileMapSensorComponent(bool _isActive, IMessenger* _messenger,
		IDroppedObjectView* _droppedObjectView);

	DroppedKatanaTileMapSensorComponent(IMessenger* _messenger, IDroppedObjectView* _droppedObjectView);
