...
class DroppedKatanaMovementComponent : public MovementComponent
{
private:
	Inject<IDroppedObjectView> droppedObjectView_;

public:
	DroppedKatanaMovementComponent(bool _isActive, IMessenger* _messenger,
		IDroppedObjectView* _droppedObjectView);

	DroppedKatanaMovementComponent(IMessenger* _messenger, IDroppedObjectView* _droppedObjectView);
