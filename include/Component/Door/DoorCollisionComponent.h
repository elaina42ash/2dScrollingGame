...
public:
	DoorCollisionComponent(bool _isActive, IMessenger* _messenger, IStaticObjectView* _staticObjectView);

	DoorCollisionComponent(IMessenger* _messenger, IStaticObjectView* _staticObjectView);
