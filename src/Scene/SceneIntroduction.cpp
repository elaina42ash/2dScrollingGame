...
void SceneIntroduction::Render()
{
	...
	PrintText(L"操作説明", 350.0f, 150.0f);	
	PrintText(L"Space：ジャンプ", 350.0f, 200.0f);
	PrintText(L"E：武器を変更する", 350.0f, 250.0f);
	PrintText(L"G：武器を捨てる", 350.0f, 300.0f);
	PrintText(L"J：攻撃", 350.0f, 350.0f);
	PrintText(L"L：ダッシュ", 350.0f, 400.0f);
	PrintText(L"K：インタラクト", 350.0f, 450.0f);
