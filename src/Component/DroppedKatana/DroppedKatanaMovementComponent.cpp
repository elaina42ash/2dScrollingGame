...
DroppedKatanaMovementComponent::DroppedKatanaMovementComponent(bool _isActive, IMessenger* _messenger,
	IDroppedObjectView* _droppedObjectView) : MovementComponent(_isActive, _messenger),
	droppedObjectView_(_droppedObjectView)
{
}

DroppedKatanaMovementComponent::DroppedKatanaMovementComponent(IMessenger* _messenger,
	IDroppedObjectView* _droppedObjectView) : MovementComponent(_messenger),
	droppedObjectView_(_droppedObjectView)
{
}

void DroppedKatanaMovementComponent::Move(const Lib::Math::Vector2f& _velocity)
{
#ifdef max
#undef max
#endif
...
void DroppedKatanaMovementComponent::Init()
{
	MovementComponent::Init();
}

void DroppedKatanaMovementComponent::Update()
{
...
void DroppedKatanaMovementComponent::Render()
{
	MovementComponent::Render();
}

void DroppedKatanaMovementComponent::Term()
{
	MovementComponent::Term();
}

void DroppedKatanaMovementComponent::HandleMessage(const IEventMessage& _msg)
{

}

void DroppedKatanaMovementComponent::Reset()
{
